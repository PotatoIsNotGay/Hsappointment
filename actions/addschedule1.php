...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['time'])) {
        ...
        try {
            ...
            $stmt = $conn->prepare("INSERT INTO schedules1 (time) VALUES (:time)");
            ...
            $_SESSION['status'] = '<div class="alert alert-success" role="alert">Schedule added successfully to Schedule 1!</div>';
